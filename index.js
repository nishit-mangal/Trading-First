...
wss.on("connection", (client, req) => {
	try {
		...
		console.log("requestUrl: ", requestUrl, ", protocol: ", protocol);
		...
		client.on("message", async (message) => {
			...
			if (splitMsg[0] === "SUBSCRIBE")
				await clientSubscriptionInstance.clientSubscribesToTicker(
					splitMsg[1],
					userId,
					token
				);
			...
			console.log(
				"Active tickers:",
				clientSubscriptionInstance.getArrayOfActiveTickers()
			);
		});
